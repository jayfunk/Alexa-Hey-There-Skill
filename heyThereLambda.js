...
function getWelcomeResponse(callback) {
  ...
  const firstExampleText = 'Start by saying, send a message to Danielle';
  const speechOutput = `Hey There! is a simple tool allowing you to send messages to a preconfigured set of friends. ${firstExampleText}`;
  const shouldEndSession = false;

  callback(
    sessionAttributes,
    buildSpeechletResponse(cardTitle, speechOutput, firstExampleText, shouldEndSession)
  );
}
